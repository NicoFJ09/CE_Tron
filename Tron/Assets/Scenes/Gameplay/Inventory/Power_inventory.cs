...
public class PowerInventoryUI : MonoBehaviour
{
    private Inventory inventory;

    public Transform powerSlotContainer;
    public float slotCellSize = 40f;

    private void Awake()
    {
        powerSlotContainer = transform.Find("Powerslot");
    }
    ...
    {
        RefreshInventorySlots(inventory.GetPowerStack(), powerSlotContainer, power => power.GetPowerSprite());
    }
